...
class Processor(IO):
    ...
    def __init__(self, argv=None):
        ...
        self.load_data()
        self.load_optimizer()
        if self.arg.checkpoint:
            self.load_checkpoint(self.arg.checkpoint)
        ...
        if self.arg.phase == 'train':
            ...
            for epoch in range(self.arg.start_epoch, self.arg.num_epoch):
                ...
                if self.arg.save_interval == -1:
                    ...
                    self.io.save_model(self.model, filename, self.optimizer, epoch)
    ...
    def get_parser(add_help=False):
        ...
        parser.add_argument('--checkpoint', default=None, help='the weights and optimizer state for resuming training')
