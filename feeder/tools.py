...
transform_order = {
    ...
    'smpl_24':[0, 2, 1, 3, 5, 4, 6, 8, 7, 9, 11, 10, 12, 14, 13, 15, 17, 16, 19, 18, 21, 20, 22, 23],
    ...
    'berkeley_mhad_43': [0, 2, 1, 6, 4, 5, 3, 10, 8, 9, 7, 19, 20, 21, 22, 23, 24, 25, 26, 11, 12, 13, 14, 15, 16, 17, 18, 
                         35, 36, 37, 38, 39, 40, 41, 42, 27, 28, 29, 30, 31, 32, 33, 34]
}
...
def random_spatial_flip(seq, p=0.5):
    if random.random() < p:
        ...
        if (V == 25):
            ...
            index = transform_order['berkeley_mhad_43']
        trans_seq = seq[:, :, index, :]
        return trans_seq
    else:
        return seq
